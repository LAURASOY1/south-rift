...
function App() {
  ...
  const facilities = [
    ...
    },
    {
      ...
      bookable: true,
      image: 'https://images.pexels.com/photos/159844/computer-room-computers-school-159844.jpeg?auto=compress&cs=tinysrgb&w=800'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-purple-50 via-white to-purple-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <div className="animate-fade-in-up">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              <span className="text-gray-900">South Rift</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="group flex items-center text-gray-700 hover:text-purple-600 transition-colors">
                <div className="w-12 h-12 bg-purple-100 backdrop-blur-md rounded-full shadow-lg flex items-center justify-center mr-3 group-hover:shadow-xl group-hover:shadow-purple-500/25 transition-shadow">
        ...
        {/* Floating Elements */}
        <div className="absolute top-20 left-10 w-20 h-20 bg-purple-300/40 rounded-full animate-float"></div>
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-purple-200/50 rounded-full animate-float-delayed"></div>
        <div className="absolute top-1/2 left-20 w-16 h-16 bg-purple-400/30 rounded-full animate-float-slow"></div>
      </section>
            ...
            <div key={level} className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {Object.entries(categories).map(([category, courses]) => (
                  <div key={category} className={`bg-white/90 backdrop-blur-md rounded-2xl border border-purple-200 hover:border-purple-400 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 flex flex-col ${!expandedCategories[`${level}-${category}`] ? 'h-80' : 'self-start'}`}>
